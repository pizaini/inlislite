...
?>
	...
	<td style="width:50%;padding-bottom: 25px; padding-right: 55px; text-align: left;">
		...
		<table style="width:212px; " cellpadding="0" cellspacing="0">
			...
			<tr>
				<td style="height:150px; border-bottom:solid 1px #CCC; border-right:solid 1px #CCC;border-left:solid 1px #CCC; font-weight: normal; font-size: 16px; text-align: center"><?=\common\components\CollectionHelpers::getLabelCallNumber($LabelData['CallNumber'])?></td>
			</tr>
		</table>
	</td>
