	...
	<td style="width:50%;padding-bottom: 10px; padding-right: 10px; text-align: left;">
		<table style="width:283px; " cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width:25%;border-top:solid 1px #CCC;border-bottom:solid 1px #CCC; border-right:solid 1px #CCC;text-align: center <?=$warna?>"  rowspan="2"><?=str_replace(' ', '<br>', $LabelData['CallNumber'])?></td>
			</tr>
			<tr>
