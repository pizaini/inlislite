...
?>
	...
	<td style="width:50%;padding-bottom: 10px; padding-right: 10px; text-align: left;">
		<table style="width:283px; " cellpadding="0" cellspacing="0">
			...
			<tr>
				<td style="height:90px; width:212px; text-align: center;padding-left: 3px; padding-right: 3px;border-left:solid 1px #CCC; border-bottom:solid 1px #CCC; border-right:solid 1px #CCC;">
