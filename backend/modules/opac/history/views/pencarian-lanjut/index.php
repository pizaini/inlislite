...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Opac'), 'url' => ['#']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'History'), 'url' => Url::to(['/opac/history'])];
...
<div class="historyopac-index">
    ...
    <?php Pjax::begin(); echo GridView::widget([
        ...
        'columns' => [
            ...
            [
            'attribute'=>'Bahasa',
            'label'=>yii::t('app','Bahasa')
            ],
            [
            'attribute'=>'Bentuk_Karya',
            'label'=>yii::t('app','Bentuk Karya')
            ],
            [
            'attribute'=>'Target_Pembaca',
            'label'=>yii::t('app','Target Pembaca')
            ],
            [
            'attribute'=>'jenis_bahan',
