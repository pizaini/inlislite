        ...
        'columns' => [
            ...
            [
                ...
                'value'=>function ($model, $key, $index, $widget) { 
                    ...
                    $col  =  yii::t('app','Nomor Transaksi : ')."<b>" .
                        Html::a(Yii::t('app',  $model->CollectionLoan_id), ['detail-transaksi-peminjaman','noanggota'=>$model->member->MemberNo,'notransaksi'=>$model->CollectionLoan_id], ['data-toggle'=>"modal",
                                'data-target'=>"#myModalDetailtrx",
                                'data-title'=>"Detail Peminjaman No.".$model->CollectionLoan_id,]). "</b><br/>" ;
                    $col .=  yii::t('app','No.Anggota      : ')."<b>" .
                    ...
                    $col .=  yii::t('app','Nama Anggota    : ')."<b>" . $model->member->Fullname . "</b>" ;
                    return "<pre>".$col."</pre>";
                },
...
echo '<div class="myModal-body"></div>';
