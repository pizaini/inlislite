                                           ...
                                           //Tag Code
                                            ...
                                            $var = '<span class="'.$classvalidatemandatory.'"  id="status'.$tagvalidate.'">
                                                      ...
                                                      <div '.$classgroup.'>
                                                              ...
                                                              <textarea class="form-control'.$classtajuk.'" style="resize: vertical;height:34px;width:100%" '.$onkeyuptajuk.$onfocuscallnumber.' '.$textdisabled.' id="TagsValue_'.$tag.'_'.$i.'" name="TagsValue['.$tag.']['.$i.']">'.$value2.'</textarea>';
                                            if($isSerial ==1 && $for=='coll' && $tag=='863')
                                            {
                                                $htmlrecord863 .= $var;
                                            }else{
                                      ...
                                      $value = str_replace('"', "&#34;", $value);
                                        ...
                                        $var = '<span class="'.$classvalidatemandatory.'"  id="status'.$tagvalidate.'">
                                                  ...
                                                  <div '.$classgroup.'>
                                                          ...
                                                          <textarea class="form-control'.$classtajuk.'" style="resize: vertical;height:34px;width:100%" '.$onkeyuptajuk.$onfocuscallnumber.' '.$textdisabled.' id="TagsValue'.$tagcodeJs.$indexJs.'" name="TagsValue'.$tagcode.$index.'">'.$value.'</textarea>';
                                        if($isSerial ==1 && $for=='coll' && $tag=='863')
                                        {
                                            $htmlrecord863 .= $var;
                                        }else{
...
<input type="hidden" id="rdas" value="<?=$rda?>">
