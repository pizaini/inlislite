...
// $relatorTerm = ArrayHelper::map(Refferenceitems::findByRelatorCreatorTerm(),'Code','Name');
// $relatorTerm = ArrayHelper::map(Refferenceitems::findByRelatorCreatorTerm(),'Name','Name');
// print_r($relatorTerm);die;
                              ...
                              <label class="control-label col-sm-2" for="email"><?=Yii::t('app', $translateTag100);?></label>
                                <div class="col-sm-9">
                                    ...
                                    <div class="btm-add-on" style="text-align:left">
                                     <input type="hidden" name="CollectionBiblio[AuthorType]" value="">
                                      <div id="collectionbiblio-authortype">

                                        <?php //if($listvar['tajuktag'][$key] == '700') {?>
                                          <label id="opx0_0"><input type="radio" id="radio_caGNabes3PEGc" name="CollectionBiblio[AuthorType]" value="0"> <?= yii::t('app','Nama Depan')?></label>
                                          <label id="opx1_0"><input type="radio" id="radio_caVk53pOMBU5g" name="CollectionBiblio[AuthorType]" value="1"> <?= yii::t('app','Nama Belakang')?></label>
                                          <label id="opx2_0"><input type="radio" id="radio_caFVvHRj4tt6k" name="CollectionBiblio[AuthorType]" value="3"> <?= yii::t('app','Nama Keluarga')?></label>
                                        <?php //}else{ ?>
                                          <label id="opx3_0"><input type="radio" id="radio11x_caGNabes3PEGc" name="CollectionBiblio[AuthorType]" value="0"> <?= yii::t('app','Nama Dibalik')?></label>
                                          <label id="opx4_0"><input type="radio" id="radio11x_caVk53pOMBU5g" name="CollectionBiblio[AuthorType]" value="1"> <?= yii::t('app','Nama Yuridiksi')?></label>
                                          <label id="opx5_0"><input type="radio" id="radio11x_caF6NxJYasdDs" name="CollectionBiblio[AuthorType]" value="2"> <?= yii::t('app','Nama ditulis langsung')?></label>
                                            ...
                                            <?php
                                              if(count($listvar['tajuk']) > 0){
                                                ...
                                                foreach ($listvar['tajuk'] as $key => $value) {
                                                  ...
                                                  {
                                                    $displaystatus700 = "";
                                                    $displaystatus7xx = "style=\"display: none\"";
                                                  }else{
                                                    $displaystatus7xx = "";
                                                    $displaystatus700 = "style=\"display: none\"";
                                                  }
                                               ...
                                               <input type="hidden" id="Ruasid_<?=$listvar['tajuktag'][$key]?>_<?=$indexruas?>" name="Ruasid[<?=$listvar['tajuktag'][$key]?>][<?=$indexruas?>]"  value="<?=$taglist['ruasid'][$listvar['tajuktag'][$key]][$indexruas]?>" size="3" />
                                                <?php if($rda=='1') { ?>
                                                  <div class="row" style="margin-top:5px">
                                                    <div class="col-sm-3" style="padding-right: 0px">
                                                       <?php
                                                          $rel = Yii::$app->db->createCommand("SELECT refferenceitems.Code, refferenceitems.Name FROM refferenceitems INNER JOIN refferences ON refferences.ID = refferenceitems.Refference_id WHERE refferences.Name = 'Relator Term Kreator'")->queryAll();
                                                          echo '<select class="form-control" id="collectionbiblio-tajuktag-'.$key.'" name="CollectionBiblio[TajukTag]['.$key.']" onchange="ShowOptionTajuk('.$key.');">';

                                                            foreach ($rel as $relatorTerm) {
                                                              if($listvar['tajuktag'][$key] == '700'){
                                                                  if(strpos($listvar['tajuk'][$key], $relatorTerm['Name'])){

                                                                    echo '<option value="'.$relatorTerm['Code'].' | '.$relatorTerm['Name'].'" selected>'.$relatorTerm['Name'].'</option>';
                                                                  }else{
                                                                    echo '<option value="'.$relatorTerm['Code'].' | '.$relatorTerm['Name'].'">'.$relatorTerm['Name'].'</option>';
                                                                  }
                                                              }else{
                                                                  if(strpos($listvar['tajuktag'][$key], $relatorTerm['Code']) !== false){
                                                                    echo '<option value="'.$relatorTerm['Code'].' | '.$relatorTerm['Name'].'" selected>'.$relatorTerm['Name'].'</option>';
                                                                  }else{
                                                                    echo '<option value="'.$relatorTerm['Code'].' | '.$relatorTerm['Name'].'">'.$relatorTerm['Name'].'</option>';
                                                                  }
                                                    ...
                                                    <div class="col-sm-9" style="padding-left: 0px">
                                                        <div class="input-group">
                                                          ...
                                                          ?>
                                                            ...
                                                            <button id="btnSubject" class="btn btn-success" type="button" onclick="AddTajukRDA();"><i class="glyphicon glyphicon-plus"></i></button>
                                                          <?php
                                                          }else{
                                                          ?>
                                                  ...
                                                  <div class="btm-add-on" style="text-align:left">
                                                     <input type="hidden" name="CollectionBiblio[TajukInd][<?=$key?>]" value="">
                                                      <div id="collectionbiblio-tajukind-<?=$key?>">
                                                        ...
                                                        <?php //if($listvar['tajuktag'][$key] == '700') {?>
                                                          <label id="opttaj0_<?=$key?>" <?=$displaystatus700?>><input <?=$type2?> type="radio" id="tajukind_X_<?=$key?>" name="CollectionBiblio[TajukInd][<?=$key?>]" value="0"> <?= yii::t('app','Nama Depan')?></label>
                                                          <label id="opttaj1_<?=$key?>" <?=$displaystatus700?>><input <?=$type3?> type="radio" id="tajukind_0_<?=$key?>" name="CollectionBiblio[TajukInd][<?=$key?>]" value="1"> <?= yii::t('app','Nama Belakang')?></label>
                                                          <label id="opttaj2_<?=$key?>" <?=$displaystatus700?>><input <?=$type5?> type="radio" id="tajukind_1_<?=$key?>" name="CollectionBiblio[TajukInd][<?=$key?>]" value="3"> <?= yii::t('app','Nama Keluarga')?></label>
                                                        <?php //}else{ ?>
                                                          <label id="opttaj3_<?=$key?>" <?=$displaystatus7xx?>><input <?=$type6?> type="radio" id="tajukind_2_<?=$key?>" name="CollectionBiblio[TajukInd][<?=$key?>]" value="0"> <?= yii::t('app','Nama Dibalik')?></label>
                                                          <label id="opttaj4_<?=$key?>" <?=$displaystatus7xx?>><input <?=$type7?> type="radio" id="tajukind_3_<?=$key?>" name="CollectionBiblio[TajukInd][<?=$key?>]" value="1"> <?= yii::t('app','Nama Yuridiksi')?></label>
                                                          <label id="opttaj5_<?=$key?>" <?=$displaystatus7xx?>><input <?=$type4?> type="radio" id="tajukind_4_<?=$key?>" name="CollectionBiblio[TajukInd][<?=$key?>]" value="2"> <?= yii::t('app','Nama Ditulis Langsung')?></label>
                                                        <?php //} ?>
                                                      </div>
                                                  </div>
                                              ...
                                              <?php if($rda == "1"){ ?>
                                                  <div class="row">
                                                     <div class="col-sm-3" style="padding-right: 0px">
                                                        <?php
                                                            $rel = Yii::$app->db->createCommand("SELECT refferenceitems.Code, refferenceitems.Name FROM refferenceitems INNER JOIN refferences ON refferences.ID = refferenceitems.Refference_id WHERE refferences.Name = 'Relator Term Kreator'")->queryAll();
                                                            echo '<select class="form-control" id="collectionbiblio-tajuktag-0" name="CollectionBiblio[TajukTag][0]" onchange="ShowOptionTajuk(0);">';
                                                              foreach ($rel as $relatorTerm) {
                                                                echo '<option value="'.$relatorTerm['Code'].' | '.$relatorTerm['Name'].'">'.$relatorTerm['Name'].'</option>';
                                                              }
                                                            echo '</select>';
                                                     ...
                                                     <div class="col-sm-9" style="padding-left: 0px">
                                                        <div class="input-group">
                                                          <?php echo Html::activeTextInput($modelbib,'Tajuk[]',['class'=>'tag700_0 form-control tajukpengarang',"onkeyup"=>"AutoCompleteOn(this,'pengarang');",'style'=>'width:100%','placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', $translateTag7XX).'...','id' => 'TagsValue_700_0']); ?>
                                                            ...
                                                            <span class="input-group-btn">
                                                              <button id="btnTajuk" class="btn btn-success pull-right" type="button" onclick="AddTajukRDA();"><i class="glyphicon glyphicon-plus"></i></button>
                                                            </span>
                                                        </div>
                                                      </div>
                                                    </div>
                                                  ...
                                                  <!-- <div class="btm-add-on" style="text-align:left">
                                                    ...
                                                    <div id="collectionbiblio-tajukind-0">
                                                        ...
                                                        <label id="rda_opttaj0_0"><input checked type="radio" id="rda_tajukind_X_0" name="CollectionBiblio[TajukInd][0]" value="0"> <?= yii::t('app','Nama Depan')?></label>
                                                        <label id="rda_opttaj1_0"><input type="radio" id="rda_tajukind_0_0" name="CollectionBiblio[TajukInd][0]" value="1"> <?= yii::t('app','Nama Belakang')?></label>
                                                        <label id="rda_opttaj2_0"><input type="radio" id="rda_tajukind_1_0" name="CollectionBiblio[TajukInd][0]" value="3"> <?= yii::t('app','Nama Keluarga')?></label>



                                                        <label id="rda_opttaj3_0" style="display: none"><input type="radio" id="rda_tajukind_2_0" name="CollectionBiblio[TajukInd][0]" value="0"> <?= yii::t('app','Nama Dibalik')?></label>
                                                        <label id="rda_opttaj4_0" style="display: none"><input type="radio" id="rda_tajukind_3_0" name="CollectionBiblio[TajukInd][0]" value="1"> <?= yii::t('app','Nama Yuridiksi')?></label>
                                                        <label id="rda_opttaj5_0" style="display: none"><input type="radio" id="rda_tajukind_4_0" name="CollectionBiblio[TajukInd][0]" value="2"> <?= yii::t('app','Nama Ditulis Langsung')?></label>
...
<input type="hidden" id="hdnAjaxUrlRefference" value="<?=Yii::$app->urlManager->createUrl(["pengkatalogan/katalog/set-refference"])?>">
<?php
...
<script type="text/javascript">
  $( document ).ready(function() {
    ...
    if($("#collectionbiblio-authortag").val()=="100")
    {
      ...
      $("#opx4_0").show();
      $("#opx5_0").show();
      $("#radio11x_"+AuthorTag).prop("checked",true);
    }
  });
