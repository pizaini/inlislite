...
/**
 * MataUangController implements the CRUD actions for Currency model.
 */
class MataUangController extends Controller
{
    ...
    {
        $jenis= Currency::findOne($id)->Currency;
         try {
            ...
            Yii::$app->getSession()->setFlash('failed', [
                        ...
                        'duration' => 5000,
                        'icon' => 'fa fa-info-circle',
                        'message' => Yii::t('app','Gagal Terhapus, jenis mata uang '). $jenis .Yii::t('app',' terdapat koleksi'),
                        'title' => 'Warning',
                        'positonY' => Yii::$app->params['flashMessagePositionY'],
                        'positonX' => Yii::$app->params['flashMessagePositionX']
                    ]);
