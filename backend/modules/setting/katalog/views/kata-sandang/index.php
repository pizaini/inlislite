...
$this->title = Yii::t('app', 'Kata Sandang');
...
<div class="library-index">
 ...
 'columns' => [
            ...
            'Name',
            [
            'attribute'=>'JumlahKarakter',
            'label'=> yii::t('app','Jumlah Karakter')
            ], 
            ...
            [
				...
				'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span> '.Yii::t('app', 'Update'), Yii::$app->urlManager->createUrl(['setting/katalog/kata-sandang/update','id' => $model->ID,'edit'=>'t']), [
                                                    'title' => Yii::t('app', 'Update'),
                                                    'class' => 'btn btn-primary btn-sm'
                                                  ]);},
												  
                'delete' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span> '.Yii::t('app', 'Delete'), Yii::$app->urlManager->createUrl(['setting/katalog/kata-sandang/delete','id' => $model->ID,'edit'=>'t']), [
