...
use common\models\KataSandangSearch;
 ...
 */
class KataSandangController extends Controller
{
    ...
    {
        $searchModel = new KataSandangSearch;
    ...
    {
        if (($model = KataSandang::findOne($id)) !== null) {
            return $model;
        } else {
