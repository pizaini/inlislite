 ...
 * @var common\models\MasterProgramStudiSearch $searchModel
 */

$this->title = Yii::t('app', 'Program Studi');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="master-program-studi-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?php /* echo Html::a(Yii::t('app', 'Create {modelClass}', [
    'modelClass' => 'Master Program Studi',
		...
		'columns' => [
            ...
            [
				...
				'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span> '.Yii::t('app', 'Update'), Yii::$app->urlManager->createUrl(['setting/member/program-studi/update','id' => $model->id,'edit'=>'t']), [
                                                    'title' => Yii::t('app', 'Edit'),
                                                    'class' => 'btn btn-primary btn-sm'
                                                  ]);},
												  
                'delete' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span> '.Yii::t('app', 'Delete'), Yii::$app->urlManager->createUrl(['setting/member/program-studi/delete','id' => $model->id,'edit'=>'t']), [
