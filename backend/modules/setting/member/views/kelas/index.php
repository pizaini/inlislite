...
<div class="kelas-siswa-index">
    ...
    <?php Pjax::begin(); echo GridView::widget([
        ...
        'columns' => [
            ...
            [
            'attribute'=>'namakelassiswa',
            'label'=>yii::t('app','Nama Klass'),
            ],
            ...
            [
                ...
                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span> '.Yii::t('app', 'Update'), Yii::$app->urlManager->createUrl(['setting/member/kelas/update','id' => $model->id,'edit'=>'t']), [
                                                    'title' => Yii::t('app', 'Update'),
                                                    'class' => 'btn btn-primary btn-sm'
                                                  ]);},
                'delete' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span> '.Yii::t('app', 'Delete'), Yii::$app->urlManager->createUrl(['setting/member/kelas/delete','id' => $model->id,'edit'=>'t']), [
