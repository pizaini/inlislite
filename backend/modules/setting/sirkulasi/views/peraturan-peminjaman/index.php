 ...
 * @var common\models\CollectionruleSearch $searchModel
 */

$this->title = Yii::t('app', 'Jenis Akses');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="collectionrules-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?php /* echo Html::a(Yii::t('app', 'Create {modelClass}', [
    'modelClass' => 'Collectionrules',
 ...
 'columns' => [
            ...
            [
				...
				'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span> '.Yii::t('app', 'Update'), Yii::$app->urlManager->createUrl(['setting/sirkulasi/peraturan-peminjaman/update','id' => $model->ID,'edit'=>'t']), [
                                                    'title' => Yii::t('app', 'Update'),
                                                    'class' => 'btn btn-primary btn-sm'
                                                  ]);},
												  
                'delete' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span> '.Yii::t('app', 'Delete'), Yii::$app->urlManager->createUrl(['setting/sirkulasi/peraturan-peminjaman/delete','id' => $model->ID,'edit'=>'t']), [
