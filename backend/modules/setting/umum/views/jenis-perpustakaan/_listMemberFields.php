...
$this->title = Yii::t('app', 'Kustomisasi Form Entri Keanggotaan');
...
<div class="members-form">
    <div class="page-header">
        ...
        <h3><?= Yii::t('app','Isian yang dimunculkan untuk form entri keanggotaan') ?> | <?= Html::encode($jenis_perpus) ?></h3>
    </div>
<?php
echo '<p>';
...
// custom gridview value
            ...
            [
                ...
                'checkboxOptions' => function ($searchModel, $key, $index, $column) {
                    ...
                    // echo'<pre>';print_r($searchModel->name);echo'<pre>';
