...
$this->title = Yii::t('app', 'Kustomisasi Entri Anggota Online');
...
<div class="members-form">
    <div class="page-header">
        ...
        <h3><?= Yii::t('app','Isian yang dimunculkan untuk form entri anggota online') ?> | <?= Html::encode($jenis_perpus) ?></h3>
    </div>
<?php
echo '<p>';
...
// custom gridview value
            ...
            [
                ...
                'checkboxOptions' => function ($searchModel, $key, $index, $column) {
                    // return [
                    //     'checked' => $searchModel->getFormAnggotaOnline($_GET["id"],$searchModel->id),
