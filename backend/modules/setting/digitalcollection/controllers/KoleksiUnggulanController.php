...
class KoleksiUnggulanController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $model->Value1=Yii::$app->config->get('ShowKoleksiUnggulanLKD');
        $model->Value2=Yii::$app->config->get('KoleksiUnggulanShowLKD');
        ...
        if ($model->load(Yii::$app->request->post())) {
            if ($model->validate()) 
            {
                ...
                Yii::$app->config->set('ShowKoleksiUnggulanLKD', Yii::$app->request->post('DynamicModel')['Value1']);
                Yii::$app->config->set('KoleksiUnggulanShowLKD', Yii::$app->request->post('DynamicModel')['Value2']);
    ...
    public function actionPilihJudul()
    {
        ...
        $dataProvider = $searchModel->advancedSearchLKD(0,$rules);
        ...
        public function actionTambah($id)
    {
        ...
        (int) $count = KriteriaKoleksi::find()
                    ->where(['catalog_id' => $id,'jns_kriteria' => 'koleksi_unggul','isLKD' => '1'])
                    ->count();
