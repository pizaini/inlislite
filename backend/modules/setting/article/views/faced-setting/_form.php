...
<div class="Pengaturanparameters-form">
    <div class="form-group">
        ...
        <h2> Pengaturan faset pengarang</h2>
        ...
        <h2> Pengaturan faset penerbit</h2>
        ...
        &nbsp;<?= Html::submitButton(Yii::t('app', 'Save'), ['class' => 'btn btn-primary']) ?>
        <h2> Pengaturan faset lokasi penerbitan</h2>
        ...
        &nbsp;<?= Html::submitButton(Yii::t('app', 'Save'), ['class' => 'btn btn-primary']) ?>
        <h2> Pengaturan faset tahun terbit</h2>
