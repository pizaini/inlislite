...
$ckriteria = [
        ...
        'data_entry' => yii::t('app','Tanggal Entri'),
        'petugas' => yii::t('app','Kataloger')];
?>
    ...
    <div class="col-sm-4 padding0">
        <div class="input-group">
            ...
            <div class="input-group-btn">
                <button type="button" class="btn btn-danger remove-field" onclick="minus();"><span class="glyphicon glyphicon-minus-sign"></span></button>
    ...
    $('#pilihan-Kriteria').on('change','.pilihKriteria<?= $i ?>',function(){ 
        ...
        $.get('load-filter-kriteria',{kriteria : kriteria},function(data){
            ...
            else 
            {
                ...
                $('.content-kriteria').find('#w0').kvDatepicker({format: 'dd-mm-yyyy', todayHighlight: true,});
                $('.content-kriteria').find('#w0-2').kvDatepicker({format: 'dd-mm-yyyy',todayHighlight: true});
            }
        });
    });
</script>
