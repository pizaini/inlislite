...
$this->title = yii::t('app','Ucapan Terima Kasih');
        ...
        <div id="SearchFilter" class="col-sm-12">
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <!-- Pilih Kriteria -->
                    <div class="form-group">
                            <label for="" class="col-sm-2 control-label" style="margin-left:0px;"><?= Yii::t('app','Jenis Pengiriman') ?></label>

                            <div class="col-sm-4 padding0">
                                <?= Select2::widget([
                                'name' => 'jenis_pengirim',
                                'data' => ['DL' => yii::t('app','Datang Langsung'), 'P' => yii::t('app','POS')],
                                'options' => [
                                'placeholder' => Yii::t('app','Semua'),
                                'id' => 'kategori_tgl',
                                'class' => 'select2'
                                ],
                                ]); ?>
...
$this->registerJs("
    ...
    $('#tampilkan_frekuensi').click(function(){
        $.ajax({
            type:\"POST\",
            url:'show-pdf?tampilkan=laporan-deposit-terima-kasih',
            data:form.serialize(),
    ...
    $('#export-excel').click(function(){
        $.ajax({
            type:\"POST\",
            url: 'show-pdf?tampilkan=export-excel-deposit-terima-kasih',
            data:form.serialize(),
            async: false,
              context: document.body,
              success: function(){ 
                 window.location.assign('export-excel-deposit-terima-kasih')
              }
            });
    ...
    $('#export-excel-odt').click(function(){
        $.ajax({
            type:\"POST\",
            url: 'show-pdf?tampilkan=export-excel-odt-deposit-terima-kasih',
            data:form.serialize(),
            async: false,
              context: document.body,
              success: function(){ 
                 window.location.assign('export-excel-odt-deposit-terima-kasih')
              }
            });
    ...
    $('#export-word').click(function(){
        $.ajax({
            type:\"POST\",
            url: 'show-pdf?tampilkan=export-word-deposit-terima-kasih',
            data:form.serialize(),
            async: false,
              context: document.body,
              success: function(){ 
                 window.location.assign('export-word-deposit-terima-kasih?type=doc')
              }
            });
    ...
    $('#export-word-odt').click(function(){
        $.ajax({
            type:\"POST\",
            url: 'show-pdf?tampilkan=export-word-odt-deposit-terima-kasih',
            data:form.serialize(),
            async: false,
              context: document.body,
              success: function(){ 
                 window.location.assign('export-word-deposit-terima-kasih?type=odt')
              }
            });
    ...
    $('#export-pdf').click(function(){
        $.ajax({
            type:\"POST\",
            url: 'show-pdf?tampilkan=export-pdf-deposit-terima-kasih',
            data:form.serialize(),

              context: document.body,
              success: function(){ 
                 window.location.assign('export-pdf-deposit-terima-kasih')
              }
            });
