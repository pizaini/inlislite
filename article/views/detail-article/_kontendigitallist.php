...
<div class="table-responsive" id="kontendigital">
    ...
    <table class="table table-striped2 table-bordered">
        ...
        <tr>
            ...
            <?php
            for ($i = 0; $i < $countCollectionList; $i++) {
            ?>
        <tr>
            <td><?= $i+1 ?></td>
            ...
            {
                $fakePath = DirectoryHelpers::GetTemporaryFolderArticle($dataCollectionList[$i]['ID'],2);
                ...
                $fakePath = DirectoryHelpers::GetTemporaryFolderArticle($dataCollectionList[$i]['ID'],1);
                if((!isset($noAnggota)) && $dataCollectionList[$i]['IsPublish']==2){
