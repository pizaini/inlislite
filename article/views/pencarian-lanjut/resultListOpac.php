                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <table class="table2" style="background:transparent" width="100%">
                                                        <tr>
                                                            <th colspan="2"><a class="topnav-content"> <?= $dataResult[$i]['title_article'] ?>
                                                            </th>
                                                        </tr>
                                                       <!-- <tr>
                                                        ...
                                                        <tr>
                                                            <td valign=top>Sumber Artikel</td>
                                                            <?php echo "<td><a href=\"pencarian-sederhana?action=pencarianSederhana&ruas=Judul&bahan=&katakunci=&CID=".$dataResult[$i]['CatalogId']."\"> ".$dataResult[$i]['title']." </a></td> "; ?>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                if($dataResult[$i]['KONTEN_DIGITAL']==NULL){
                                                                    ...
                                                                    echo"<a data-toggle='collapse' data-target='#collapseKontenDigital".$dataResult[$i]['SerialID']."'  class='show_hide' id='showmenu".$dataResult[$i]['SerialID']."' onclick='kontenDigital(".$dataResult[$i]['SerialID'].",".$dataResult[$i]['CatalogId'].")' href='javascript:void(0)' >";
                                                                }
...
/*                                                                if ($dataResult[$i]['ALL_BUKU'] != 0) {
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-11">
                                                    <div class="collapse"
                                                         id="collapseKontenDigital<?= $dataResult[$i]['SerialID']; ?>">
                                                        <div id="kontenDigitalShow<?= $dataResult[$i]['SerialID']; ?>">
