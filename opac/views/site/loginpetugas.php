...
$this->title = 'Buku Tamu Pengunjung';
...
<div class="box-body" style="padding:50px 0">
    ...
    <div class="col-sm-4">
        <center>
            <h4>Silahkan login<br>
                untuk menentukan lokasi OPAC
            </h4>

            <?= Html::beginForm(Yii::$app->request->baseUrl.'/site/login-petugas', 'post', ['class'=>'uk-width-medium-1-1 uk-form uk-form-horizontal']); ?>
