    ...
    <div class="box box-default">
        <div class="box-body" style="padding:20px 0">
            <div class="breadcrumb">
                <ol class="breadcrumb">
                    <li><a href="<?=$base.'search'; ?>">Home</a></li>
                ...
                <div class="col-sm-9">
                    <form id="theForm" method="POST" action="">
                        ...
                        <table class="table2 table-striped" width="100%">
                            ...
                            $pub = explode(";",$dataResult[$i]['Publikasi']);
                    ...
                    <div class="list-group facet" id="side-panel-authorStr">
                        ...
                        <div id="side-collapse-authorStr" class="collapse in">
                            ...
                            for($i=0;$i<sizeof($dataFacedAuthor);$i++){
                                if($dataFacedAuthor[$i]['key']==NULL || $dataFacedAuthor[$i]['key']=='') $dataFacedAuthor[$i]['key']='-';
                                if($i==$FacedAuthorMin){echo$divHiddenBuka;}
                                echo"
					
							<a style=\"padding: 8px 40px 8px 8px;\" class=\"list-group-item \" href='?action=".$action."&katakunci=".urlencode($katakunci)."&ruas=".urlencode($ruas)."&bahan=".urlencode($bahan)."&fAuthor=".urlencode($dataFacedAuthor[$i]['key'])."&fPublisher=".urlencode($fPublisher)."&fPublishLoc=".urlencode($fPublishLoc)."&fPublishYear=".urlencode($fPublishYear)."&fSubject=".urlencode($fSubject)."&fBahasa=".urlencode($fBahasa)."     '>".$dataFacedAuthor[$i]['key']."<span class=\"badge\">".$dataFacedAuthor[$i]['doc_count']."</span></a>
                    ...
                    <div class="list-group facet" id="side-panel-publisherStr">
                        ...
                        <div id="side-collapse-publisherStr" class="collapse in">
                            ...
                            for($i=0;$i<sizeof($dataFacedPublisher);$i++){
                                if($dataFacedPublisher[$i]['key']==NULL || $dataFacedPublisher[$i]['key']=='') $dataFacedPublisher[$i]['key']='-';
                                if($i==$FacedPublisherMin){echo$divHiddenBuka;}
                                echo"
							<a style=\"padding: 8px 40px 8px 8px;\"class=\"list-group-item \"href='?action=".$action."&katakunci=".urlencode($katakunci)."&ruas=".urlencode($ruas)."&bahan=".urlencode($bahan)."&fAuthor=".urlencode($fAuthor)."&fPublisher=".urlencode($dataFacedPublisher[$i]['key'])."&fPublishLoc=".urlencode($fPublishLoc)."&fPublishYear=".urlencode($fPublishYear)."&fSubject=".urlencode($fSubject)."&fBahasa=".urlencode($fBahasa)."     '>".$dataFacedPublisher[$i]['key']."<span class=\"badge\">".$dataFacedPublisher[$i]['doc_count']."</span></a>
                    ...
                    <div class="list-group facet" id="side-panel-publislocationStr">
                        ...
                        <div id="side-collapse-publislocationStr" class="collapse in">
                            ...
                            for($i=0;$i<sizeof($dataFacedPublishLocation);$i++){
                                if($dataFacedPublishLocation[$i]['key']==NULL || $dataFacedPublishLocation[$i]['key']=='') $dataFacedPublishLocation[$i]['key']='-';
                                if($i==$FacedPublishLocationMin){echo$divHiddenBuka;}
                                echo"
					
							<a style=\"padding: 8px 40px 8px 8px;\" class=\"list-group-item \" href='?action=".$action."&katakunci=".urlencode($katakunci)."&ruas=".urlencode($ruas)."&bahan=".urlencode($bahan)."&fAuthor=".urlencode($fAuthor)."&fPublisher=".urlencode($fPublisher)."&fPublishLoc=".urlencode($dataFacedPublishLocation[$i]['key'])."&fPublishYear=".urlencode($fPublishYear)."&fSubject=".urlencode($fSubject)."&fBahasa=".urlencode($fBahasa)."     '>".$dataFacedPublishLocation[$i]['key']."<span class=\"badge\">".$dataFacedPublishLocation[$i]['doc_count']."</span></a>
                    ...
                    <div class="list-group facet" id="side-panel-publisyearStr">
                        ...
                        <div id="side-collapse-publisyearStr" class="collapse in">
                            ...
                            for($i=0;$i<sizeof($dataFacedPublishYear);$i++){
                                if($dataFacedPublishYear[$i]['key']==NULL || $dataFacedPublishYear[$i]['key']=='') $dataFacedPublishYear[$i]['key']='-';
                                if($i==$FacedPublishYearMin){echo$divHiddenBuka;}
                                echo"
					
							<a style=\"padding: 8px 40px 8px 8px;\" class=\"list-group-item \" href='?action=".$action."&katakunci=".urlencode($katakunci)."&ruas=".urlencode($ruas)."&bahan=".urlencode($bahan)."&fAuthor=".urlencode($fAuthor)."&fPublisher=".urlencode($fPublisher)."&fPublishLoc=".urlencode($fPublishLoc)."&fPublishYear=".urlencode($dataFacedPublishYear[$i]['key'])."&fSubject=".urlencode($fSubject)."&fBahasa=".urlencode($fBahasa)."     '>".$dataFacedPublishYear[$i]['key']."<span class=\"badge\">".$dataFacedPublishYear[$i]['doc_count']."</span></a>
                    ...
                    <div class="list-group facet" id="side-panel-subjectStr">
                        ...
                        <div id="side-collapse-subjectStr" class="collapse in">
                            ...
                            for($i=0;$i<sizeof($dataFacedSubject);$i++){
                                if($dataFacedSubject[$i]['key']==NULL || $dataFacedSubject[$i]['key']=='') $dataFacedSubject[$i]['key']='-';
                                if($i==$FacedSubjectMin){echo$divHiddenBuka;}
                                echo"
					
							<a style=\"padding: 8px 40px 8px 8px;\" class=\"list-group-item \" href='?action=".$action."&katakunci=".urlencode($katakunci)."&ruas=".urlencode($ruas)."&bahan=".urlencode($bahan)."&fAuthor=".urlencode($fAuthor)."&fPublisher=".urlencode($fPublisher)."&fPublishLoc=".urlencode($fPublishLoc)."&fPublishYear=".urlencode($fPublishYear)."&fSubject=".urlencode($dataFacedSubject[$i]['key'])."&fBahasa=" . urlencode($fBahasa) . "     '>".$dataFacedSubject[$i]['key']."<span class=\"badge\">".$dataFacedSubject[$i]['doc_count']."</span></a>
                    ...
                    <span style=\"background-color:#c5d4ff;\" class=\"badge\">
                        ...
                        <div id="side-collapse-BahasaStr" class="collapse in">
                            ...
                            for($i=0;$i<sizeof($dataFacedBahasa);$i++){
                                if($dataFacedBahasa[$i]['key']==NULL || $dataFacedBahasa[$i]['key']=='') $dataFacedBahasa[$i]['key']='-';
                                if($i==$FacedBahasaMin){echo$divHiddenBuka;}
                                echo"
                
                        <a style=\"padding: 8px 40px 8px 8px;\" class=\"list-group-item \" href='?action=".$action."&katakunci=".urlencode($katakunci)."&ruas=".urlencode($ruas)."&bahan=".urlencode($bahan)."&fAuthor=".urlencode($fAuthor)."&fPublisher=".urlencode($fPublisher)."&fPublishLoc=".urlencode($fPublishLoc)."&fPublishYear=".urlencode($fPublishYear)."&fSubject=".urlencode($fSubject)."&fBahasa=".urlencode($dataFacedBahasa[$i]['key'])."     '>".$dataFacedBahasa[$i]['key']."<span class=\"badge\">".$dataFacedBahasa[$i]['doc_count']."</span></a>
