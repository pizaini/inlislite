    ...
    public function actionIndex() {
        ...
        if (isset($_GET['tag']) && isset($_GET['findBy']) && isset($_GET['query']) && isset($_GET['query2'])) {
            ...
            if (Yii::$app->request->get() && addslashes($_GET['action']) === "browse") {
                ...
                $command = Yii::$app->db->createCommand("CALL insertTempTelusurOpac('" . $tag . "','" . $findBy . "','" . $query . "','" . $query2 . "','" . $fAuthor . "','" . $fPublisher . "','" . $fPublishLoc . "','" . $fPublishYear . "','" . $fSubject . "','" . $fBahasa . "','');");
                $command->execute();
                ...
                //buat generate param request faced
