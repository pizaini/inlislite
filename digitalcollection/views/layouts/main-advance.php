...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title><?= Yii::t('app', 'Layanan Koleksi Digital')?> - Perpusnas RI</title>
                    ...
                    <div class="navbar-header">
                        <div class="title">
                           ...
                           <!--  <div class="image"> <a href='<?=$homeUrl?>'> <img src="<?= Yii::$app->urlManager->createUrl('../uploaded_files/aplikasi/logo_perpusnas_2015.png') ?>" class="img-logo" height="65" width="70"> </a></div> -->
                            ...
                            <div class="text">
                                <h3 style="margin-top: 20px;"><?= Yii::t('app', 'Layanan Koleksi Digital')?></h3>
                                <div class="clear"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3"> 
                              <select class="form-control" name="bahan" >
								...
								?>
								<option value="Semua Format File" selected><?= yii::t('app','Semua Format File')?></option>
