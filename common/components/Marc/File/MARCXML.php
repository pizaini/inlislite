...
require_once __DIR__.'/MARCBASE.php';
require_once __DIR__.'/MARC.php';
require_once __DIR__.'/MARC/Record.php';
require_once __DIR__.'/MARC/Field.php';
require_once __DIR__.'/MARC/Control_Field.php';
require_once __DIR__.'/MARC/Data_Field.php';
require_once __DIR__.'/MARC/Subfield.php';
require_once __DIR__.'/MARC/Exception.php';
require_once __DIR__.'/MARC/List.php';
