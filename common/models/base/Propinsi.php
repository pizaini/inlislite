...
/**
 * This is the base-model class for table "propinsi".
 *
 * @property integer $ID
...
class Propinsi extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'ID' => Yii::t('app', 'ID'),
            'NamaPropinsi' => Yii::t('app', 'Nama Propinsi'),
    ...
    {
        return $this->hasMany(\common\models\Kabupaten::className(), ['PropinsiID' => 'ID']);
    }
