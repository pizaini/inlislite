...
/**
 * This is the base-model class for table "collectionsources".
 *
 * @property integer $ID
 ...
 */
class Collectionsources extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\common\models\Collections::className(), ['Source_id' => 'ID']);
    }
