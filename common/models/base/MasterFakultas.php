...
/**
 * This is the base-model class for table "master_fakultas".
 *
 * @property integer $id
 ...
 */
class MasterFakultas extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\common\models\MasterJurusan::className(), ['id_fakultas' => 'id']);
    }
    ...
    {
        return $this->hasMany(\common\models\Members::className(), ['Fakultas_id' => 'id']);
    }
