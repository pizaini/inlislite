...
/**
 * This is the base-model class for table "vw_akuisisi_raw_status".
 *
 * @property integer $ID
 ...
 */
class VwAkuisisiRawStatus extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ID', 'WorksheetID', 'AkuisisiID'], 'integer'],
