...
/**
 * MasterPendidikanSearch represents the model behind the search form about `common\models\MasterPendidikan`.
 */
class MasterPendidikanSearch extends MasterPendidikan
{
