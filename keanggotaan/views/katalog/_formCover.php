...
<div class="form-group">
   ...
   <?php echo FileInput::widget([
        ...
        //        ],
                ...
                'uploadUrl' => Url::to(['/katalog/upload-cover?id='.$model->ID.'&refer='.\common\components\CatalogHelpers::encrypt_decrypt('encrypt',$referrerUrl)]),
                'allowedFileExtensions'=> ["jpg", "png", "gif", "jpeg", "bmp", "tiff", "tif"],
