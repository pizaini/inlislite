...
Modal::end();
?>
<input type="hidden" id="hdnAjaxUrlFormCollectionSave" value="<?=Yii::$app->urlManager->createUrl(["katalog/save-catalogs-collection"])?>">
<input type="hidden" id="hdnAjaxUrlFormCollection" value="<?=Yii::$app->urlManager->createUrl(["katalog/bind-catalogs-collection"])?>">
