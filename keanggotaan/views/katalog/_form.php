      ...
      "select2:select" => 'function() { 
          ...
          isLoading=true;
           $.ajax({
              type     :"POST",
              cache    : false,
              url  : "'.Yii::$app->urlManager->createUrl(["katalog/entry-bib-by-worksheet"]).'?id="+id+"&for='.$for.'&rda='.$rda.'",
...
<input type="hidden" id="hdnAjaxUrlAutosuggestCallnumber" value="<?=Yii::$app->urlManager->createUrl(["katalog/auto-suggest-call-number"])?>">
...
<input type="hidden" id="hdnAjaxUrlPilihJudul" value="<?=Yii::$app->urlManager->createUrl(["katalog/pilih-judul"])?>">
<input type="hidden" id="hdnAjaxUrlFormSimple" value="<?=Yii::$app->urlManager->createUrl(["katalog/entry-simple"])?>">
<input type="hidden" id="hdnAjaxUrlFormAdvance" value="<?=Yii::$app->urlManager->createUrl(["katalog/entry-advance"])?>">
<input type="hidden" id="hdnAjaxUrlNoInduk" value="<?=Yii::$app->urlManager->createUrl(["katalog/bind-no-induk"])?>">
<input type="hidden" id="hdnAjaxUrlPartner" value="<?=Yii::$app->urlManager->createUrl(["katalog/bind-partners"])?>">
<input type="hidden" id="hdnAjaxUrlCheckDuplicate" value="<?=Yii::$app->urlManager->createUrl(["katalog/check-duplicate"])?>">
<input type="hidden" id="hdnAjaxUrlRemoveTag" value="<?=Yii::$app->urlManager->createUrl(['katalog/remove-taglist'])?>">
