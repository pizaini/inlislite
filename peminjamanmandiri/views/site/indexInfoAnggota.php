		    ...
		    <tr>
		        <td valign="top" class='icon-users'>&nbsp;&nbsp;
		        	<div class="input-group">
		        		<?= Html::activeTextInput($model,'nomorBarcode',['class'=>'form-control','style'=>'width:100%','placeholder'=>Yii::t('app', 'Enter No.Barcode').'']); ?>
    	 ...
    	 echo GridView::widget([
	        ...
	        ['class' => 'yii\grid\SerialColumn'],
	         ...
	         //    [
	        	...
	        	// ],
	            [
	        		'header'=>yii::t('app','Penerbitan'),
	        		'attribute'=>'Publikasi'
	        	],
	        	[
	        		'header'=>yii::t('app','Tgl.Pinjam'),
