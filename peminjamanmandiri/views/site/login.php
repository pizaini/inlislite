...
$this->title = yii::t('app','Peminjaman Mandiri');
...
<div class="box-body" style="padding:50px 0">
    ...
    <div class="col-sm-4">
        <center>
            <h4><?= yii::t('app','Silahkan Login') ?><br>
                <?= yii::t('app','untuk menentukan lokasi peminjaman') ?>
            </h4>
            ...
            <?= Html::beginForm(Yii::$app->request->baseUrl.'/site/login', 'post', ['class'=>'uk-width-medium-1-1 uk-form uk-form-horizontal']); ?>
                <div class="login-form">
                    ...
                    <button class="btn btn-success btn-md btn-block" type="submit"><?= yii::t('app','Login') ?></button>
