        ...
        <div id="search<?= $dataResult[1]['CatalogId']; ?>">
            <div class="row">
                <div class="col-sm-1"><?php
                    ...
                    ?> &nbsp; <input type="checkbox" name="catID[]" value="<?= $dataResult[1]['CatalogId']; ?>"  > <input type="hidden"  id='catalogID<?= $dataResult[1]['CatalogId']; ?>'  name="catalogID" value="<?= $dataResult[1]['CatalogId']; ?>"> &nbsp;<?php echo"<a onclick=\"favorite(" . $dataResult[1]['CatalogId'] . ")\" href=\"javascript:void(0)\"  title=\"Tambah ke Favorite\"><span class=\"glyphicon glyphicon-star\"></span></a>"; ?>
                </div>
