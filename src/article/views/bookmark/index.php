                      ...
                      <div class="col-sm-12">
                        ...
                        <?php   
                          ...
                          for($start;$start<=$count;$start++){
                            $pub = explode(";",OpacHelpers::getPublisher($dataBookmark[$start]['id']));
                          ...
                          <div class="col-sm-9">
                                 <table class="table2" style="background:transparent" width="100%">
                                  ...
                                  <tr>
                                      <td>Ketersediaan</td>
                                      <td>: <?php if($dataBookmark[$start]['ALL_BUKU']!=0){echo"<a data-toggle='collapse' data-target='#collapsecollection".$dataBookmark[$start]['id']."'  id='showmenu".$dataBookmark[$start]['id']."' onclick='collection(".$dataBookmark[$start]['id'].")' href='javascript:void(0)' >"; } echo $dataBookmark[$start]['JML_BUKU']." dari ".$dataBookmark[$start]['ALL_BUKU']." ekslempar"; ?> </a></td>
                                  </tr>
                                  </table>
                          </div>  </div>
