            ...
            if ($base!='pencarian-lanjut/index' && $base!='browse/index' && $base!='usulan-koleksi/index') {
              ?>
                <section class="content-search">
                  ...
                  <div class="row">&nbsp;</div>
                  <div class="row">
                  <div class="col-sm-12">&nbsp; &nbsp; <a href="<?php echo $homeUrl."pencarian-lanjut"; ?>"><?= Yii::t('app', 'Pencarian lanjut')?> </a> - <a href="<?php echo $homeUrl."riwayat-pencarian"; ?>">Riwayat Pencarian </a> - <a href="" data-toggle="modal" data-target="#modalBantuan">Bantuan</a> </div>
                  </div>
