...
$cat = Yii::$app->db->createCommand("SELECT c.`id`,c.`Title` FROM catalogs c JOIN worksheets w ON c.`Worksheet_id`=w.`ID` WHERE w.`ISSERIAL` =1 ORDER BY c.`Title` ASC;")->queryAll();

if ($cat){
    foreach ($cat as $key => $value){
        $catArticle[$value['id']]= $value['Title'];
    }
}
                    ...
                    <form method="GET" action="<?php echo $homeUrl; ?>pencarian-lanjut">
                      <div id="Dynamic">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2"> <label><?= yii::t('app','Jenis Bahan')?></label> </div>
                          ...
                          <div class="row">
                            <!--<div class="col-sm-1"> </div>-->
                            <div class="col-sm-2"> <label><?= yii::t('app','Target pembaca')?></label> </div>
                            <input type="hidden" name="action" value="pencarianLanjut"  />
                            <div class="col-sm-4">
                          ...
                          <!----div judul article-->
                          <!--<div class="row">
                              <div class="col-sm-2"> <label>Judul katalog</label> </div>
                              <div class="col-sm-10">
                                  <div class="input-group">
                                      <?/*= Select2::widget([
                                          ...
                                          'options' => [
                                              'multiple' => true,
                                              'placeholder' => Yii::t('app','Choose').' '.Yii::t('app','Judul'),
                                          ],
                                      ]); */?>
                                  </div>
                            ...
                            <div class="col-sm-2">
                              ...
                              <div class="col-sm-3">                  
                                  <select name="tag[]" class="form-control">
                                    ...
                                    <option value="Subject"><?= yii::t('app','Subyek')?></option>
                                    <option value="Nomor Panggil">ISBN</option>
                                    <option value="Sembarang Ruas"><?= yii::t('app','Sembarang Ruas')?></option>
                                  </select>

                              </div>
                                <div class="col-sm-1"><a href="" id="AddInpElem"> <span  class="glyphicon glyphicon-plus-sign"> </span> </a> </div>
                          ...
                          <div class="row">
                            <div class="col-sm-2"> </div>
                            <div class="col-sm-1"> <div class="form-group"><input type="submit" class="btn btn-success btn-sm btn-block"value=<?= yii::t('app','Cari')?>/> </div> </div>
