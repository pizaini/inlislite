...
<div class="loan-histori">
    ...
    <?php echo GridView::widget([
        ...
        'columns' => [
        ['class' => 'yii\grid\SerialColumn'],
            ['attribute'=>'Code','label'=>yii::t('app','Kode')],
            ['attribute'=>'Name','label'=>yii::t('app','Nama'),],
            ['attribute'=>'Jumlah','label'=>yii::t('app','Jumlah'),'hAlign' => GridView::ALIGN_CENTER,],
        ],
        'responsive'=>true,
        'hover'=>true,
        'condensed'=>true,
