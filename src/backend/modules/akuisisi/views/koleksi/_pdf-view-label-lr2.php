	...
	<?php foreach ($LabelData as $LabelData): ?>
		<table style="width: 100%;" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width:25%;border-bottom:solid 1px #CCC; border-right:solid 1px #CCC;border-top:solid 1px #CCC;text-align: center" rowspan="2"><?=str_replace(' ', '<br>', $LabelData['CallNumber'])?></td>
			</tr>
			<tr>
