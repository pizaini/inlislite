	...
	<td style="width:50%;padding-bottom: 25px; padding-right: 55px; text-align: left;">
		...
		<table style="width:212px; " cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<table width="100%" cellspacing="1" cellpadding="3" bgcolor="#FFF" style="margin: 0px">
					<tr>
						<td style="text-align: center <?=$warna1?>"><?=$LabelData['KodeWarna1']?></td>
					</tr>
					<tr>
						<td style="text-align: center <?=$warna2?>"><?=$LabelData['KodeWarna2']?></td>
					</tr>
					<tr>
						<td style="text-align: center <?=$warna3?>"><?=$LabelData['KodeWarna3']?></td>
					</tr>
					<tr>
						<td style="text-align: center <?=$warna4?>"><?=$LabelData['KodeWarna4']?></td>
					</tr>
					<tr>
						<td style="text-align: center <?=$warna5?>"><?=$LabelData['KodeWarna5']?></td>
					</tr>
				</table>
