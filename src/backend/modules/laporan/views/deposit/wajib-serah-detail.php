...
$this->title = yii::t('app','Laporan SSKCKR Wajib Serah Detail');
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 row">
                            ...
                            <!-- Harian -->
                            <div class="col-sm-10" id="periodeHarian"  style="margin-left:-10px;">
                                <?=  DatePicker::widget([
                                    'name' => 'from_date', 
                    ...
                    <!-- Pilih Kriteria -->
                    <div class="form-group">
                            <label for="" class="col-sm-2 control-label" style="margin-left:0px;"><?= Yii::t('app','Kategori Tanggal') ?></label>

                            <div class="col-sm-4 padding0">
                                <?= Select2::widget([
                                'name' => 'kategori_tgl',
                                'data' => ['dibuat' => yii::t('app','Tanggal Dibuat'), 'penerimaan' => yii::t('app','Tanggal Penerimaan')],
                                'options' => [
...
$this->registerJs("
    ...
    $('#tampilkan_frekuensi').click(function(){
        $.ajax({
            type:\"POST\",
            url:'show-pdf?tampilkan=laporan-deposit-wajib-serah-detail',
            data:form.serialize(),
    ...
    $('#export-excel').click(function(){
        $.ajax({
            type:\"POST\",
            url: 'show-pdf?tampilkan=export-excel-deposit-wajib-serah-detail',
            data:form.serialize(),
            async: false,
              context: document.body,
              success: function(){ 
                 window.location.assign('export-excel-deposit-wajib-serah-detail')
              }
            });
    ...
    $('#export-excel-odt').click(function(){
        $.ajax({
            type:\"POST\",
            url: 'show-pdf?tampilkan=export-excel-odt-deposit-wajib-serah-detail',
            data:form.serialize(),
            async: false,
              context: document.body,
              success: function(){ 
                 window.location.assign('export-excel-odt-deposit-wajib-serah-detail')
              }
            });
    ...
    $('#export-word').click(function(){
        $.ajax({
            type:\"POST\",
            url: 'show-pdf?tampilkan=export-word-deposit-wajib-serah-detail',
            data:form.serialize(),
            async: false,
              context: document.body,
              success: function(){ 
                 window.location.assign('export-word-deposit-wajib-serah-detail?type=doc')
              }
            });
    ...
    $('#export-word-odt').click(function(){
        $.ajax({
            type:\"POST\",
            url: 'show-pdf?tampilkan=export-word-odt-deposit-wajib-serah',
            data:form.serialize(),
            async: false,
              context: document.body,
              success: function(){ 
                 window.location.assign('export-word-deposit-wajib-serah-detail?type=odt')
              }
            });
    ...
    $('#export-pdf').click(function(){
        $.ajax({
            type:\"POST\",
            url: 'show-pdf?tampilkan=export-pdf-deposit-wajib-serah-detail',
            data:form.serialize(),

              context: document.body,
              success: function(){ 
                 window.location.assign('export-pdf-deposit-wajib-serah-detail')
              }
            });
