...
$this->title = yii::t('app','Laporan Koleksi Periodik');
                                ...
                                <div class="col-sm-4 padding0">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                            ...
                                            <button id="add" type="button" class="btn btn-success add-field" onclick="plus();"><span class="glyphicon glyphicon-plus-sign"></span></button>
                                        </div>
...
var count = 0;
var countEl = document.getElementsByClassName("multi-field");
function plus(){
    count++;
    countEl.value = count;
