        ...
        <div id="SearchFilter" class="col-sm-12" >
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <!-- Pilih Kriteria -->
                    <div class="form-group multi-field-wrapper" id="pilihan-Kriteria" style="margin-left:-10px;">
                    ...
                    <div class="form-group" style="margin-top: -10px; margin-left:-5px;">
                        ...
                        <div class="col-sm-10 row">
                            <div class="checkbox">
                                <label style="margin-right: 50px;"><input type="checkbox" Name="belum_dikembalikan" value="belum_dikembalikan"> <?=yii::t('app','Belum dikembalikan')?> </label>
                                <label style="margin-right: 50px;"><input type="checkbox" Name="sudah_dikembalikan" value="sudah_dikembalikan"> <?=yii::t('app','Sudah dikembalikan')?></label>
                            </div> 
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10 container-fluid padding0 multi-fields" id="appendContentHere" style="margin-left:-3px;">
                    ...
                    <div class="col-sm-10 col-sm-offset-2 padding0">
                        ...
                        <div class="btn-group" style="cursor:pointer;">
                           ...
                           <ul class="dropdown-menu">
                             ...
                             <li><a id="export-odt-data">Open-Office-Word-data</a></li>
...
$this->registerJs("
    ...
    $('.add-field').click(function(e) {    
        $.get('load-selecter-loker',{ i : i },function(data){
    ...
    $('#export-excel-data').click(function(){
        $.ajax({
            type:\"POST\",
            url: 'show-pdf?tampilkan=export-excel-data',
            data:form.serialize(),
            async: false,
              context: document.body,
              success: function(){ 
    ...
    $('#export-odt-data').click(function(){
        $.ajax({
            type:\"POST\",
            url: 'show-pdf?tampilkan=export-odt-data',
            data:form.serialize(),
            async: false,
              context: document.body,
              success: function(){ 
