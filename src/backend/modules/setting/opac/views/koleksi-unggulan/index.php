        ...
        'columns' => [
            ...
            [
                ...
                'delete' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span> '.Yii::t('app', 'Hapus'), Yii::$app->urlManager->createUrl(['setting/opac/koleksi-unggulan/delete','id' => $model->ID,'edit'=>'t']), [
