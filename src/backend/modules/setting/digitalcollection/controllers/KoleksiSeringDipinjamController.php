...
class KoleksiSeringDipinjamController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $model->Value1=Yii::$app->config->get('ShowKoleksiSeringDipinjamLKD');
        $model->Value2=Yii::$app->config->get('KoleksiSeringDipinjamShowLKD');
        ...
        if ($model->load(Yii::$app->request->post())) {
            if ($model->validate()) 
            {
                ...
                Yii::$app->config->set('ShowKoleksiSeringDipinjamLKD', Yii::$app->request->post('DynamicModel')['Value1']);
                Yii::$app->config->set('KoleksiSeringDipinjamShowLKD', Yii::$app->request->post('DynamicModel')['Value2']);
