...
<div class="col-md-6">
 ...
 <?= $form->field($user, 'newPassword')->passwordInput()->label(Yii::t('app', 'Password Baru'))  ?>
 <?= $form->field($user, 'confirmNewPassword')->passwordInput()->label(Yii::t('app', 'Ulangi Password Baru'))  ?>
