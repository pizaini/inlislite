...
$this->title = Yii::t('app', 'Kustomisasi Form Info Anggota');
...
<div class="members-form">
    <div class="page-header">
        ...
        <h3><?= Yii::t('app','Isian yang dimunculkan untuk form info anggota') ?> | <?= Html::encode($jenis_perpus) ?></h3>
    </div>
<?php
echo '<p>';
...
// custom gridview value
            ...
            [
                ...
                'checkboxOptions' => function ($searchModel, $key, $index, $column) {
                    // return [
                    //     'checked' => $searchModel->getFormInfoAnggota($_GET["id"],$searchModel->id),
