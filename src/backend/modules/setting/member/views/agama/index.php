 ...
 * @var common\models\AgamaSearch $searchModel
 */
            ...
            'Name',
             /*[
                ...
                'value'=>function ($model, $key, $index,$column) {
                            return '<input type="text" name="fname['.$index.']" value="'.$model->Name.'">';
                        },
                'format'=>'raw'
            ],*/
            [
				...
				'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span> '.Yii::t('app', 'Update'), Yii::$app->urlManager->createUrl(['setting/member/agama/update','id' => $model->ID,'edit'=>'t']), [
                                                    'title' => Yii::t('app', 'Update'),
                                                    'class' => 'btn btn-primary btn-sm'
                                                  ]);},

                'delete' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span> '.Yii::t('app', 'Delete'), Yii::$app->urlManager->createUrl(['setting/member/agama/delete','id' => $model->ID,'edit'=>'t']), [
