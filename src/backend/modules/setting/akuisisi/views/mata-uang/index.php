 ...
 * @var common\models\CurrencySearch $searchModel
 */
        ...
        'columns' => [
            ...
            [
                ...
                'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span> '.Yii::t('app', 'Update'), Yii::$app->urlManager->createUrl(['setting/akuisisi/mata-uang/update','id' => $model->Currency,'edit'=>'t']), [
                                                    'title' => Yii::t('app', 'Update'),
                                                    'class' => 'btn btn-primary btn-sm'
                                                  ]);},
                'delete' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span> '.Yii::t('app', 'Delete'), Yii::$app->urlManager->createUrl(['setting/akuisisi/mata-uang/delete','id' => $model->Currency,'edit'=>'t']), [
