...
/**
 * RekananController implements the CRUD actions for Partners model.
 */
class RekananController extends Controller
{
    ...
    {
        $jenis= Partners::findOne($id)->Name;
         try {
            ...
            Yii::$app->getSession()->setFlash('failed', [
                        ...
                        'duration' => 5000,
                        'icon' => 'fa fa-info-circle',
                        'message' => Yii::t('app','Gagal Terhapus, jenis rekanan '). $jenis .Yii::t('app',' terdapat koleksi'),
                        'title' => 'Warning',
                        'positonY' => Yii::$app->params['flashMessagePositionY'],
                        'positonX' => Yii::$app->params['flashMessagePositionX']
                    ]);
