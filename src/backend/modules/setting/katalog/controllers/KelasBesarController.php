...
use common\models\MasterKelasBesarSearch;
 ...
 */
class KelasBesarController extends Controller
{
    ...
    {
        $searchModel = new MasterKelasBesarSearch;
    ...
    {
        if (($model = MasterKelasBesar::findOne($id)) !== null) {
            return $model;
        } else {
