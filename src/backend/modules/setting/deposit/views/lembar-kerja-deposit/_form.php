        ...
        'columns' => [
            ...
            [
                ...
                'checkboxOptions' => function ($searchModel, $key, $index, $column) {
                    return [
                        'value' => $searchModel->ISDEPOSIT,
                        'checked' => $searchModel->ISDEPOSIT,
                        'onchange' => 'var checked = $(this).is(":checked");$.ajax("is-deposit", {data: {id: $(this).closest("tr").data("key"), checked: checked}});',
                    ];
                }
            ],
