...
<div class="deposit-group-ws-form">
...
'id_group'=>['type'=> Form::INPUT_TEXT, 'options'=>['placeholder'=>Yii::t('app', 'Otomotatis by Sistem').'...', 'maxlength'=>50,'disabled'=>true]], 

'group_name'=>['type'=> Form::INPUT_TEXT, 'options'=>['placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', 'Nama Group').'...', 'maxlength'=>255]], 
