...
?>
         ...
         <div class="login-form">
                ...
                <?= Html::a(Yii::t('app', 'Masuk'),'javascript:void(0)', ['class' => 'btn btn-success btn-md btn-block', 'name' => 'login-button','onClick'=>'loginAnggota();']) ?>
                    <div><?= Html::a(Yii::t('app', 'Lupa password / No. Anggota ?'), ['../keanggotaan/site/request-password-reset'],['target' => '_blank']) ?>.</div>
                    <br>
                    <div><?= Html::a(Yii::t('app', 'Login Petugas ?'), ['site/login-petugas'],['target' => '_blank']) ?>.</div>
                </div>
