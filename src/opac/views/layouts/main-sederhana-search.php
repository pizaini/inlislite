  ...
  function getData(dropdown) {
    ...
    function tampilBooking() {
        $.ajax({
            type: "POST",
            cache: false,
            url: "<?= $homeUrl ?>booking?action=showBookingDetail",
    ...
    function tampilUsulan() {
        $.ajax({
            type: "POST",
            cache: false,
            url: "<?= $homeUrl ?>usulan-koleksi?action=showUsulan",
            success: function (response) {
    ...
    function cancelBooking(id) {
        $.ajax({
            type: "POST",
            cache: false,
            url: "<?= $homeUrl ?>booking?action=cancelBooking&colID="+id,
            success: function (response) {
