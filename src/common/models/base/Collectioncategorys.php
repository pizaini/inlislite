...
/**
 * This is the base-model class for table "collectioncategorys".
 *
 * @property integer $ID
 ...
 */
class Collectioncategorys extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\common\models\Collectioncategorysdefault::className(), ['CollectionCategory_id' => 'ID']);
    }
    ...
    {
        return $this->hasMany(\common\models\Collections::className(), ['Category_id' => 'ID']);
    }
    ...
    {
        return $this->hasMany(\common\models\Memberloanauthorizecategory::className(), ['CategoryLoan_id' => 'ID']);
    }
