...
/**
 * This is the base-model class for table "jenis_kelamin".
 *
 * @property integer $ID
...
class JenisKelamin extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\common\models\Memberguesses::className(), ['JenisKelamin_id' => 'ID']);
    }
    ...
    {
        return $this->hasMany(\common\models\Members::className(), ['Sex_id' => 'ID']);
    }
