...
/**
 * This is the base-model class for table "refferences".
 *
 * @property integer $ID
 ...
 */
class Refferences extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['Format_id', 'CreateBy', 'UpdateBy'], 'integer'],
    ...
    {
        return $this->hasMany(\common\models\Refferenceitems::className(), ['Refference_id' => 'ID']);
    }
    ...
    {
        return $this->hasMany(\common\models\Worksheetfielditems::className(), ['Refference_id' => 'ID']);
    }
