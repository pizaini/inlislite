...
/**
 * This is the base-model class for table "collectionstatus".
 *
 * @property integer $ID
 ...
 */
class Collectionstatus extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\common\models\Collections::className(), ['Status_id' => 'ID']);
    }
    ...
    {
        return $this->hasMany(\common\models\Stockopnamedetail::className(), ['PrevStatusID' => 'ID']);
    }
    ...
    {
        return $this->hasMany(\common\models\Stockopnamedetail::className(), ['CurrentStatusID' => 'ID']);
    }
