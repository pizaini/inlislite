...
/**
 * MasterFakultasSearch represents the model behind the search form about `common\models\MasterFakultas`.
 */
class MasterFakultasSearch extends MasterFakultas
{
