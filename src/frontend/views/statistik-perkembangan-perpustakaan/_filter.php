...
if(isset($get)){
    ...
    $to_date = $get['to_date'];
    $bulan1 = $get['fromBulan'];
    $bulan2 = $get['toBulan'];
    $fromTahun = $get['fromTahun'];
    $toTahun = $get['toTahun'];
    $fromTahunan = $get['fromTahunan'];
    $toTahunan = $get['toTahunan'];
...
<section class="content">
    ...
    </div><!-- Line Chart Pertumbuhan Jumlah Kunjungan -->
