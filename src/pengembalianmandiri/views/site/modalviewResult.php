...
<div class="page-header row">
	<div>
      ...
      if ($totalItem > 0){
  		  	echo '<p>';
          echo '&nbsp;' .Html::a('<span class="glyphicon glyphicon-print"></span> Cetak Slip Pengembalian', '#', ['class' => 'btn btn-success','id'=>'print-slip-pengembalian',]);
          echo '&nbsp;' .Html::a('<span class="glyphicon glyphicon-print"></span> Cetak Struk Pengembalian', '#', ['class' => 'btn btn-primary','id'=>'print-struk-pengembalian',]);
          if($totalPelanggaran > 0 ) {
            echo '&nbsp;' .Html::a('<span class="glyphicon glyphicon-print"></span> Cetak Slip Pelanggaran', '#', ['class' => 'btn btn-default','id'=>'print-slip-pelanggaran',]);
            echo '&nbsp;' .Html::a('<span class="glyphicon glyphicon-print"></span> Cetak Struk Pelanggaran', '#', ['class' => 'btn btn-warning','id'=>'print-struk-pelanggaran',]);
    		  }
    			echo '</p>';
       }
			?>
