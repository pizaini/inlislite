    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="100px">Tgl. Perpanjangan</th>
          <!--<th width="100px">Hari Terlambat</th>-->
          <th width="100px">Jatuh Tempo Perpanjangan</th>
          <th width="50px">Perpanjangan</th>
          <th width="40px">&nbsp;</th>
        </tr>
      </thead>
      <tbody>
      ...
      <tfoot>
        <tr>
          <td colspan="5"><strong>Total Koleksi Yang Diperpanjang : </strong></td>
