 ...
 */
$this->title = Yii::t('app', 'Detail Perpanjangan');
...
<div class="page-header">
	<h3>
		...
		<div class="pull-left">
			...
			// Cetak button
			echo '&nbsp;' .Html::a('<span class="glyphicon glyphicon-print"></span> '. Yii::t('app', 'Cetak Slip Perpanjangan'),'#', ['class' => 'btn btn-success','id' => 'CetakSlip']);
...
<!-- KOLEKSI LOAN OUTSTANDING -->
    ...
    ?>
		...
		<div style="text-align: center; font-size: 14px; background-color: #73b9d7; padding: 10px;
                    color: #fff; text-shadow: 0 1px 2px #222; margin-bottom: 3px; border-radius: 5px;">
                    <b>KOLEKSI YANG TELAH DIPERPANJANG</b>
      	</div>
        <div>
    	<?php
    	 echo GridView::widget([
...
$url = Url::to(['perpanjangan-koleksi/print-kuitansi-perpanjangan']);
$this->registerJs("
