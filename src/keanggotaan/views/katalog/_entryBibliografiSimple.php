                    ...
                    <div id="DivSubject0">
                      ...
                      <div class="row">
                        ...
                        <div class="btm-add-on" style="text-align:left">
                          ...
                          <label id="opt0_0" style="display: none"><input type="radio" id="subjectind_0_0" name="CollectionBiblio[SubjectInd][0]" value="0"> <?= yii::t('app','Nama Depan')?></label>
                          <label id="opt1_0" style="display: none"><input type="radio" id="subjectind_1_0" name="CollectionBiblio[SubjectInd][0]" value="1"> <?= yii::t('app','Nama Belakang')?></label>
                          <label id="opt3_0" style="display: none"><input type="radio" id="subjectind_3_0" name="CollectionBiblio[SubjectInd][0]" value="3"> <?= yii::t('app','Nama Keluarga')?></label>
                          </div>
                        </div>
                                                                ...
                                                                <div id="LokasiAddList">
                                                                  ...
                                                                  ?>
                                                                      <div id="DivLokasiAdded0">
                                                                          ...
                                                                          <div class="input-group">
                                                                            <?php echo Html::activeTextInput($modelbib,'LokasiDaringAdded[0]',['class'=>'form-control','style'=>'width:100%','placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', $translateTag7XX).'...']); ?>
                                                                            <span class="input-group-btn">
                                                                              <button id="btnLokasiAdded" class="btn btn-success pull-right" type="button" onclick="AddLokasiDaring();"><i class="glyphicon glyphicon-plus"></i></button>
                                                                            </span>
                                                                          </div>
