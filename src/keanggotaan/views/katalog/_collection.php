...
<input type="hidden" id="collections_catalog_id" name="Collections[Catalog_id]" value="<?=$catalogid?>">
                ...
                <div class="form-group kv-fieldset-inline">
                  <div class="col-sm-8">
                    <?= $form->field($model,'EDISISERIAL')->textInput(['inline'=>true,'placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', 'coll_Edisiserial').'...'])?>
                  </div>
                  <div class="col-sm-4">
                    &nbsp;
                  </div>
                ...
                <div class="form-group kv-fieldset-inline">
                 ...
                 <div class="form-group kv-fieldset-inline">
                  <div class="col-sm-8">
                    <?= $form->field($model,'BAHAN_SERTAAN')->textInput(['inline'=>true,'placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', 'coll_Bahan  Sertaan').'...'])?>
                  </div>
                  <div class="col-sm-4">
                    &nbsp;
                  </div>
                 ...
                 <div class="form-group kv-fieldset-inline">
                  <div class="col-sm-8">
                    <?= $form->field($model,'KETERANGAN_LAIN')->textInput(['inline'=>true,'placeholder'=>Yii::t('app', 'Enter').' '.Yii::t('app', 'coll_Keterangan  Lain').'...'])?>
                  </div>
                  <div class="col-sm-4">
                    &nbsp;
                  </div>
                ...
                <div class="form-group kv-fieldset-inline">
                  ...
                  <div class="form-group field-collections-location_library_id">
                    <label class="control-label col-sm-4" for="collections-location_library_id">Lokasi Perpustakaan</label>
                    <div class="col-sm-8">
                    <?php 
                ...
                <div class="form-group kv-fieldset-inline">
                  ...
                  <div class="form-group field-collections-location_id required">
                    <label class="control-label col-sm-4" for="collections-location_id">Lokasi Ruang</label>
